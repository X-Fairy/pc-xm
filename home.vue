<template>
    <div class="index">
        ...
        <div class="main">
            ...
            <ul class="new">
                <!-- <a href="https://tb.53kf.com/code/client/10055204/1" style="color: #495060;"> -->
                <li @click="client">
                    
                        <img src="@/assets/images/icon/2.png" alt="">
                        <div>
                            <p class="one">在线咨询</p>
                            <p class="two">Online Consultation</p>
                        </div>
                ...
                <li @click="$router.push({path: '/order'})">
                    ...
                    <div>
                        <p class="one">招商加盟</p>
                        <p class="two">Investment Promotion</p>
                    </div>
                ...
                <li @click="$router.push({path: '/about'})">
                    ...
                    <div>
                        <p class="one">企业信息</p>
                        <p class="two">Enterprise Information</p>
                    </div>
                    
                </li>
            </ul>
            <div class="vid">                      
                <video-player style="object-fit:fill;"  id="video"  class="video-player vjs-custom-skin"   :options="playerOptions" >
                </video-player>
            </div>
            <!-- <div class="floor1">
                <div class="left">
            ...
            <div class="floor2">
                <div class="title">
                    ...
                    <h1>熙美诚品海外市场增长迅速</h1>
                    <p class="line"></p>
                    <p>好品牌无国界，截止目前，熙美诚品与<span>美国、加拿大、英国、印度、俄罗斯、新加坡、澳大利亚、巴西沙特阿拉伯等</span>确定了合作伙伴关系 与<span>全球84个国家和地区</span>达成战略合作关系，
                        平均每天有<span>1</span>家熙美诚品开业，特别是东南亚各国、俄罗斯、美国、摩洛哥、迪拜等地区，门店数量正在快速递增，熙美诚品，全球从业人员<span>8000</span>多，熙美诚品通过<span>6000</span>多款物超所值的产品，每天向全球消费者传递快乐和惊喜！</p>
            ...
            <div class="floor3">
                ...
                <ul class="content">
                    ...
                    <li>
                        <div>
                            <p class="title"><span>6</span>个大区，<span>3</span>个分公司</p>
                    ...
                    <li>
                        <div>
                            ...
                            <p class="subtitle">行业人才孵化器，六个大区巡回培训</p>
                        </div>
            ...
            <div class="floor4">
                ...
                <!-- <ul class="products">
                    ...
                    <li>
                        <img src="@/assets/images/index/product/3.png" alt="">
                        <p>数码配件</p>
                    ...
                    <li>
                        <img src="@/assets/images/index/product/5.png" alt="">
                        <p>文体办公</p>
                        <p>Office Series</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <img src="@/assets/images/index/product/7.png" alt="">
                        <p>饰品系列</p>
                        <p>Fashion Series</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <img src="@/assets/images/index/product/9.png" alt="">
                        <p>休闲食品</p>
                        <p>Snacks</p>
                    </li>
                    
                </ul> -->
                <!-- <img src="@/assets/images/addvantage/p.png" alt="" style="width: 100%"> -->
                <img src="@/assets/images/addvantage/p.png" alt="" style="width: 100%;margin-top: 20px;">  
            </div>
            <!-- <div class="product">
...
import {alert} from '@/assets/js/common.js'
export default {
    metaInfo: {
        title: '熙美诚品_快时尚百货加盟品牌', // set a title
        // meta: [
        //     {                 // set meta
        //         name: 'keyWords',
        //         content: '熙美诚品官网,快时尚百货加盟,十元店加盟,百货加盟,连锁加盟店,快时尚百货品牌,熙美诚品加盟'
        //     },
        // ]     
    },
    components: {
    ...
    created() {
        alert();
        document.getElementsByName('keywords')[0].content='熙美诚品官网,快时尚百货加盟,十元店加盟,百货加盟,连锁加盟店,快时尚百货品牌,熙美诚品加盟'
        this. getnew();
        this.toFullVideo();
    ...
    methods: {
        client(){
            ...
            window.open('https://tb.53kf.com/code/client/10055204/1');
        },
         /* 滚动显示新闻导航 */
         handleScroll(){
        ...
        getnew(){
            ...
            //    })
                for(let i in this.newList){
                    ...
                    if(this.newList[i].pathname.includes('../data')){                            
                        this.newList[i].pathname='http://www.xmcpcn.com/'+this.newList[i].pathname.substr(8);
                    }else{
