        ...
        <div class="main">
                ...
                <div class="left">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="http://www8.53kf.com/m.php?cid=72055204" style="color: #495060;"><p>在线咨询</p></a>
                        </li>
            ...
            <div class="banner2">
                <Carousel autoplay v-model="value1" loop :autoplay-speed="5000">
                    ...
                    <CarouselItem>
                        <div class="demo-carousel"><img src="@/assets/images/banner/图层 610.png" alt="">
                            <!-- <p class="text">北欧风格 - 简约时尚契合潮流</p> -->
                        </div>
                    </CarouselItem>
                    <CarouselItem>
                        <div class="demo-carousel"><img src="@/assets/images/banner/图层 611.png" alt="">
                            <!-- <p class="text">北欧风格 - 简约时尚契合潮流</p> -->
                        </div>
                    </CarouselItem>
                </Carousel>
            ...
            <div class="floor2">
                <div class="title">
                    ...
                    <p>好品牌无国界，截止目前，熙美诚品与<span>美国、加拿大、英国、印度、俄罗斯、新加坡、澳大利亚、巴西沙特阿拉伯等</span>确定了合作伙伴关系 与全球84个国家和地区达成战略合作关系，
                        平局每一天有1-2家熙美诚品开业，特别是东南亚各国、俄罗斯、美国、摩洛哥、迪拜等地区，门店数量正在快速递增，熙美诚品，全球从业人员8000+，平均每天有350万元的产品通过熙美在全球的门店，
                        传递到消费者手中，每天有180万人次光顾熙美在全球的门店</p>
                    <img src="@/assets/images/index/earth.jpg" alt="">
                </div>
            </div>
            <div class="floor3">
                <img src="@/assets/images/index/1.jpg" alt="" style="width: 100%;margin: auto;">
                <!-- <div class="info">
                        <h4>WHY CHOOSE US</h4>
                        <h1>我们的优势</h1>
                        <p class="line"></p>
                ...
                <ul class="content">
                    ...
                    <li>
                        <p class="title"><span>50000m²</span>仓储物流中心</p>
                        <p class="subtitle">为客户提供无忧的货品供给，  3.9亿库存</p>
                        
                    </li>
                    <li>
                        <p class="title">二店率高达<span>38%</span></p>
                        <p class="subtitle">老加盟商选择开2店或多店 超过400家</p>
                       
                    </li>
                    <li>
                        <p class="title"><span>10</span>年行业沉淀</p>
                        <p class="subtitle">大数据基础、团队基础、供 应链基础</p>
                    ...
                    <li>
                        <p class="title"><span>7</span>大区督导配置</p>
                ...
                <div class="banner2" style="margin-top: -5px;">
                    <Carousel autoplay v-model="value2" loop :autoplay-speed="5000">
                        <!-- <CarouselItem>
                            <div class="demo-carousel"><img src="@/assets/images/banner/1.png" alt=""></div>
                        </CarouselItem>
                        <CarouselItem>
                            <div class="demo-carousel"><img src="@/assets/images/banner/2.png" alt=""></div>
                        </CarouselItem> -->
                        <CarouselItem>
                        ...
                        <!-- <CarouselItem>
                            <div class="demo-carousel"><img src="@/assets/images/banner/6.png" alt=""></div>
                        </CarouselItem> -->
                    </Carousel>
                </div>
            </div>
            <div class="floor4">
                ...
                <h1>9大类产品</h1>
                <p class="line"></p>
                <p style="font-size: 16px;">熙美诚品将“物超所值”作为品牌的核心理念，将<span>“持续给消费者创造超越期待的产品”</span>作为企业目标，期待每件拥有自己独特触感的产品，都
                    能温柔的融入生活，简单却实用的给消费者传递快乐和惊喜，给“物超所值”一个全新的定义。一条毛巾的柔软，一顶帽子的浪漫，
                    一款耳机的精致......熙美诚品，希望每一位消费者，都能在这里得到<span>实用、好用、看得见</span>的好物，让他们与所想的生活不期而遇。
                </p>
            </div>
            <div class="product">
            ...
            <div class="floor5">
                <div class="infos">
                    ...
                    <ul>
                        <li><img src="@/assets/images/icon/circle.jpg" alt=""><p>强大选址团队，免费提供店面地址，专业评估店面可行性</p></li>
                        <li style="margin-left: 10px;"><img src="@/assets/images/icon/circle.jpg" alt=""><p>专业空间设计团队，免费设计店铺提供装修指导</p></li>
                        <li style="margin-left: 20px;"><img src="@/assets/images/icon/circle.jpg" alt=""><p>海鼎ESHOP只能ERP收银软件，全面了解爆款热销产品清单</p></li>
                        <li style="margin-left: 30px;"><img src="@/assets/images/icon/circle.jpg" alt=""><p>高级督导老师下店指导，查漏补缺提升店面营业额</p></li>
                        <li style="margin-left: 40px;"><img src="@/assets/images/icon/circle.jpg" alt=""><p>每月商学院培训支持，提高店铺运营管理能力</p></li>
                    </ul>
                </div>
            </div>
            <div class="floor6">
